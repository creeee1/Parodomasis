...
add_image_size('carousel', 500, 500, true);
...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script('owl-carousel-min-js', ASSETS_URL . '/assets/js/owl.carousel.min.js', array('jquery'), '1.0', true);



        wp_enqueue_script('jquery'); //wordpress pagal default turi jquery faila uzregistuota
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('style', ASSETS_URL . '/assets/css/style.css',
		array(), false, 'all');
		wp_register_style('all', 'https://use.fontawesome.com/releases/v5.0.10/css/all.css',
		array('style'), false, 'all');
		wp_register_style('owl-carousel', ASSETS_URL . '/assets/css/owl.carousel.css',
		array('all'), false, 'all');
		wp_register_style('owl-theme-default', ASSETS_URL . '/assets/css/owl.theme.default.css',
		array('owl-carousel'), false, 'all');
